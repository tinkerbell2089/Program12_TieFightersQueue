...
/* Course: CIS 4020 01N
/* Semester: Fall 2016
/* Assignment: Program 12 - TieFighters Queues
/* Date started: November 30,2016 
/* Date finished:November 30, 2016
/*
/* Description: This program demonstrates the use of stacks by creating 2 queues and using the different commands such as push and pop.
 */
/****************************************/
...
public class TieFightersQueues {

	final static int MAXTieFighters = 10;											//Declares Final Variable
	static Queue<String> HangarA = new LinkedList<String>();						//Initializes Stack A
	static Queue<String> HangarB = new LinkedList<String>();						//Initializes Stack B
	...
	public static void inputMethod(){
		...
		while(inputFile.hasNextLine()){										//while loop that reads until the end of the file
			...
			if (parts[0].equals("1")){ 										//if statement that accesses the subscript 0 to find the determinant code
					add(parts[1]);											//if 1 = push method
			}
				else if (parts[0].equals("2")){								//otherwise if 2 = pop method
					remove();
				}
				else removeAll();												//all else popAll method
		}
	}
	...
	/******************************************/
		public static void add(String string){
			...
			if (HangarA.size() < MAXTieFighters){													//if hangar A is < 10
				HangarA.add(string);																//push tie fighter into stack
				...
				HangarB.add(string);																//push tie fighter into stack
...
/******************************************/		
		public static void remove(){
			...
			if(!HangarA.isEmpty()){															//while Hangar A is not empty 
				String string1 = HangarA.remove();												//stores the popped tie fighters name in a string
				...
				String string2 = HangarB.remove();												//stores the popped tie fighters name in a string
...
/******************************************/	
		public static void outputMethod(){		
			...
			while (!HangarB.isEmpty()){										//while hangar is not empty pop all the tie fighters left in it
				String string2 = HangarA.remove();								//stores the popped tie fighters name in a string
